...
export const bookTemplates: BookTemplate[] = [
  {
    ...
    storyTemplate: [
      ...
      { pageNumber: 10, text: "Back home, {name} snuggled into bed. "I'll go back tomorrow," {name} whispered, already dreaming of new adventures among the stars. The End.", illustration: "🌟" },
    ],
  },
  {
    ...
    storyTemplate: [
      ...
      { pageNumber: 3, text: "The Fairy Queen welcomed {name} warmly. "We've been waiting for you, brave one. Our kingdom needs a hero!"", illustration: "👑" },
      { pageNumber: 4, text: "A mischievous troll had stolen the Crystal of Joy, and without it, the flowers couldn't bloom. {name} volunteered to help.", illustration: "🌺" },
      ...
      { pageNumber: 7, text: "The troll's cave was dark and echoey. But {name} wasn't afraid. With kindness, {name} asked the troll why he took the crystal.", illustration: "🗻" },
      ...
      { pageNumber: 10, text: "{name} stepped back through the golden door, heart full of magic. "Every act of kindness," {name} smiled, "is its own kind of magic." The End.", illustration: "✨" },
    ],
  },
  {
    id: "jungle-adventure",
    ...
    theme: "jungle",
    storyTemplate: [
      { pageNumber: 1, text: "{name} stood at the edge of a thick, green jungle. Strange calls echoed through the trees. "Let's explore!" {name} said bravely.", illustration: "🌴" },
      ...
      { pageNumber: 8, text: "Inside the cave, golden light filled the chamber. The treasure wasn't gold — it was a garden of glowing, magical flowers!", illustration: "🌺" },
  ...
  },
  {
    ...
    description: "A beautiful keepsake capturing your unique love story for weddings & anniversaries.",
    ageRange: "Adults",
    ...
    storyTemplate: [
      ...
      { pageNumber: 9, text: "This book is a reminder: love isn't just a feeling. It's a choice made every day — to show up, to be kind, to keep choosing each other.", illustration: "📖" },
      { pageNumber: 10, text: "And so the story continues, one beautiful chapter at a time. Here's to love, to laughter, and to happily ever after. The End.", illustration: "💖" },
    ],
  },
  {
    id: "ocean-explorer",
    ...
    theme: "ocean",
    storyTemplate: [
      { pageNumber: 1, text: "{name} stood on a golden beach, watching waves roll in. "I wonder what's down there," {name} said, gazing at the deep blue sea.", illustration: "🏖️" },
      { pageNumber: 2, text: "A magical seahorse appeared in the shallows. "Hop on!" it said. "I'll show you a world you've never seen!" And down they went.", illustration: "🌊" },
      ...
      { pageNumber: 4, text: "A gentle sea turtle swam alongside {name}. "I'm 100 years old," it said wisely. "And the ocean still surprises me every day."", illustration: "🐢" },
  ...
  },
  {
    ...
    storyTemplate: [
      ...
      { pageNumber: 4, text: "First mission: {name} found the lost puppy and reunited it with its owner. The little girl hugged {name} so tight. "You're my hero!"", illustration: "🐕" },
      ...
      { pageNumber: 6, text: "{name} helped the elderly neighbor carry groceries. "You've got a strong heart," she smiled. "That's the greatest superpower."", illustration: "💪" },
      ...
      { pageNumber: 9, text: "That evening, {name} looked at the cape and understood: it wasn't magic. The superpower was always inside — courage, kindness, and heart.", illustration: "❤️" },
      { pageNumber: 10, text: "{name} smiled. "Everyone can be a superhero. You just have to choose to be kind." And that's exactly what {name} did, every single day. The End.", illustration: "🌟" },
    ],
  },
  {
    id: "dinosaur-time",
    ...
    storyTemplate: [
      ...
      { pageNumber: 3, text: "A baby Triceratops waddled up and nuzzled {name}'s hand. "I'll call you Trixie," {name} laughed, patting its bumpy head.", illustration: "🦕" },
      ...
      { pageNumber: 5, text: "A mighty T-Rex appeared! But it wasn't scary at all — it was trying to reach fruit from a tall tree. {name} helped by climbing up.", illustration: "🦖" },
      ...
      { pageNumber: 9, text: "The glowing fossil began to pulse. "Time to go home," {name} sighed, hugging Trixie goodbye. "I'll never forget you."", illustration: "💫" },
